...
export class UsersService {
  ...
  register(name, lastname, username, email, password, country, city, avatar) {
    const data = {
      name: name,
      lastname: lastname,
      username: username,
  ...
  create(name, lastname, username, email, password, country, city, type, avatar) {
    const data = {
      name: name,
      lastname: lastname,
      username: username,
  ...
  get(username: string) {
    return this.http.post(`${this.uri}/get`, {username: username});
  }
  ...
  delete(username) {
    return this.http.post(`${this.uri}/delete`, {username: username});
  }

  approveRequest(username) {
    return this.http.post(`${this.uri}/requests`, {username: username});
  }
